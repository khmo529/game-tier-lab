...
FULL_KO_MAP = {
    "Ada Wong":"에이다 웡","Anis: Star":"아니스: 스타","Crown":"크라운","Flora (Treasure)":"플로라(트레저)",
    "Vesti: Tactical Upgrade":"베스티: 택티컬 업그레이드","Moran (Treasure)":"모란(트레저)","Siren":"세이렌",
    ...
    "Privaty (Treasure)":"프리바티(트레저)","Scarlet: Black Shadow":"스칼렛: 블랙 섀도우","Snow White: Heavy Arms":"백설: 헤비 암즈",
    "Red Hood B1":"레드후드 B1","Anchor: Innocent Maid":"앵커: 이노센트 메이드","Mint":"민트","Prika":"프리카","Alice":"앨리스",
    "Ein":"아인","Helm (Treasure)":"헬름(트레저)","Liberalio":"리베르타리오","Milk: Blooming Bunny":"밀크: 블루밍 버니",
    "Neon: Vision Eye":"네온: 비전 아이","Red Hood B3":"레드후드 B3","D: Killer Wife":"D: 킬러 와이프",
    "Emma: Tactical Upgrade":"엠마: 택티컬 업그레이드","Liter":"리터","Miranda (Treasure)":"미란다(트레저)","Rouge":"루주",
    ...
    "Rei Ayanami":"레이 아야나미","Scarlet":"홍련","Anis: Sparkling Summer":"아니스: 스파클링 서머","Exia (Treasure)":"엑시아(트레저)",
    "Label":"라벨","Volume":"볼륨","Zwei (Treasure)":"츠바이(트레저)","Helm: Aquamarine":"헬름: 아쿠아마린","Crust":"크러스트",
    ...
    "Jill Valentine":"질 발렌타인","Laplace (Treasure)":"라플라스(트레저)","Ludmilla: Winter Owner":"루드밀라: 윈터 오너",
    ...
    "Frima (Treasure)":"프리마(트레저)","Mica: Snow Buddy":"미카: 스노우 버디","Milk (Treasure)":"밀크(트레저)","Miranda":"미란다",
    "N102":"N102","Rapunzel":"라푼젤","Sakura":"사쿠라","Tove (Treasure)":"토브(트레저)","Zwei":"츠바이","Admi":"애드미","Anis":"아니스",
    "Arcana: Fortune Mate":"아르카나: 포츈 메이트","Centi":"센티","Centi (Treasure)":"센티(트레저)","Diesel (Treasure)":"디젤(트레저)",
    "Poli":"폴리","Poli (Treasure)":"폴리(트레저)","Rem":"렘","A2":"A2","Drake (Treasure)":"드레이크(트레저)","Emilia":"에밀리아","Eve":"이브",
    ...
    "Bay (Treasure)":"베이(트레저)","Biscuit":"비스킷","Chime":"차임","Clay":"클레이","Elegg":"엘레그","Flora":"플로라","Makima":"마키마",
    "Marciana":"마르차나","Mast":"마스트","Anne: Miracle Fairy":"앤: 미라클 페어리","Noah":"노아","Quency":"퀀시","Rupee":"루피",
    "Snow Crane":"스노우 크레인","Viper (Treasure)":"바이퍼(트레저)","2B":"2B","Drake":"드레이크","Elegg: Boom and Shock":"엘레그: 붐 앤 쇼크",
    "Epinel":"에피넬","Julia (Treasure)":"줄리아(트레저)","Kilo":"킬로","Laplace":"라플라스","Raven":"레이븐","Sakura: Bloom in Summer":"사쿠라: 블룸 인 서머",
    "Vesti":"베스티","Anchor":"앵커","Claire Redfield":"클레어 레드필드","Cocoa":"코코아","Emma":"엠마","Ether":"에테르","Mary":"메리","Mica":"미카","Milk":"밀크",
    "Misato Katsuragi":"카츠라기 미사토","Neon":"네온","Pascal":"파스칼","Ram":"람","Rei":"레이","Rosanna":"로산나","Rosanna (Treasure)":"로산나(트레저)","Sora":"소라",
